...
public class ModBlocks {
    ...
    public static final CustomBlock SCORCHED_DIRT = createCubeBlock(
            "scorched_soil",
            () -> new Block(BlockBehaviour.Properties.of()
                    .destroyTime(2.0f)
                    .explosionResistance(10.0f)
    ...
    public static CustomBlock createCustomBlock(String id, BasicBlockState basicBlockState, Supplier<? extends Block> supplier) {
        DeferredBlock<Block> _deferredBlock = BLOCKS.register(id, supplier);
        CustomBlock customBlock = new CustomBlock(id, basicBlockState, _deferredBlock);
        customBlocks.add(customBlock);
        return customBlock;
    }
    public static CustomBlock createCubeBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, CUBE_ALL, supplier);
    }
    public static CustomBlock createColumnBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, CUBE_COLUMN, supplier);
    }
    public static CustomBlock createBottomTopBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, CUBE_BOTTOM_TOP, supplier);
    }

    public static CustomBlock createStairsBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, STAIRS, supplier).addBlockTag(BlockTags.STAIRS);
    }
    public static CustomBlock createSlabBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, SLAB, supplier).addBlockTag(BlockTags.SLABS);
    }
    public static CustomBlock createButtonBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, BUTTON, supplier).addBlockTag(BlockTags.BUTTONS);
    }

    public static CustomBlock createFenceBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, FENCE, supplier).addBlockTag(BlockTags.FENCES);
    }
    public static CustomBlock createFenceGateBlock(String id, Supplier<? extends Block> supplier) {
        return createCustomBlock(id, FENCE_GATE, supplier).addBlockTag(BlockTags.FENCE_GATES);
    }
    public static CustomBlock createPressurePlateBlock(String id, Supplier<? extends Block> supplier) {
